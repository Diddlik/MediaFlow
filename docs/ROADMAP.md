...
- [ ] automatic rollback when the replacement container remains unhealthy
- [ ] automated rollback integration test against a Docker daemon
...
- [x] OpenAPI finalized
- [ ] safe container update workflow finalized
