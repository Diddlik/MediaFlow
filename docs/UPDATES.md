...
- Watchtower is archived and does not provide health-gated automatic rollback; MediaFlow therefore retains the previous image and keeps automatic rollback explicitly open rather than claiming unsupported safety.
- Pin a previous versioned image and follow [Backup and restore](BACKUP-RESTORE.md) for manual rollback.
