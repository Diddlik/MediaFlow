...
{
    private readonly string directory = Path.Combine(Path.GetTempPath(), "mediaflow-tests", Guid.NewGuid().ToString("N"));
    ...
    public async Task InitializeAsync()
    {
        ...
        var factory = new SqliteConnectionFactory(Path.Combine(directory, "mediaflow.db"));
